...
mMR_listmode_module = Extension('occiput.ScannerGeometries.Siemens_Biograph_mMR.listmode_c', [os.path.join('occiput','ScannerGeometries','Siemens_Biograph_mMR','listmode_c.c')])
mMR_physiological_module = Extension('occiput.ScannerGeometries.Siemens_Biograph_mMR.physiological_c',
                          [os.path.join('occiput','ScannerGeometries','Siemens_Biograph_mMR','physiological_c.c')])
...
setup(
    ...
    packages=[
        ...
        "occiput.ScannerGeometries",
        "occiput.ScannerGeometries.Siemens_Biograph_mMR",
    ],
    data_files=[
