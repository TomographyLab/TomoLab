...
__all__ = ['load_interfile'] #, 'listmode_to_sinogram']
...
def load_interfile(filename):
    """
    Utility function to load_interfile and parse an Interfile file.
    Args: 
    ...
    """
    parser = FileParser()
    hdr = parser.parse_file(filename)
    return hdr
