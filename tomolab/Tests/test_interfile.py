...
import unittest
from ..DataSources.FileSources import interfile
import pickle
...
class TestInterfile(unittest.TestCase): 
    ...
    def test_listmode_parse(self):
        ...
        listmode = interfile.load_interfile('../Data/interfile_xamples/pet_listmode.l.hdr')
    ...
    def test_sinogram_parse(self):
        ...
        sino = interfile.load_interfile('../Data/interfile_examples/pet_sinogram.s.hdr')
